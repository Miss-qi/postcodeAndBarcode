...
module.exports = {
    loadAllBarcodes: loadAllBarcodes, checkPostcodes: checkPostcodes,
    getPostcodes: getPostcodes, getCheckcode: getCheckcode, matchBarcodes: matchBarcodes,
    postcodeToBarcode: postcodeToBarcode, checkBarcodes: checkBarcodes,
    getBarcodeWithoutFrame: getBarcodeWithoutFrame, getDigits: getDigits,
    checkDigits: checkDigits, matchPostcodes: matchPostcodes, barcodeToPostcode: barcodeToPostcode
};
